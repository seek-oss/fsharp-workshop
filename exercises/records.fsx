...
//
type Player = { name : string; position: Coord2d }  // *** Answer ***
let player = { name = "Fred"; position = { x = 2.4; y = 9.5 } } // *** Answer ***
...
//
let player' = { player with position = { x = 0.0; y = 0.0 }} // *** Answer ***
...
//
let { name = _; position = {x = x; y = y} } = player' // *** Answer ***

// or

let { x = x'; y = y' } = player'.position // *** Answer ***
